...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x69E6DE5D, 0xF09E, 0x485E, {0x99, 0x36, 0xEB, 0x70, 0xFD, 0xCF, 0xC8, 0x2A}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MyHelloWorldInstallPPI";
...
{
  return MyHelloWorldInstallPPIEntry (FileHandle, PeiServices);
}
