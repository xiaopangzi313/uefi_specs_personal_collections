...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x69A6DE6D, 0xFA9F, 0x485D, {0x3A, 0x3D, 0xEA, 0x70, 0xFD, 0xCF, 0xC8, 0x2F}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MyHelloWorldPCD";
...
GLOBAL_REMOVE_IF_UNREFERENCED const BOOLEAN _gPcd_FixedAtBuild_PcdMyHelloWorldPrintEnable = _PCD_VALUE_PcdMyHelloWorldPrintEnable;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT16 _gPcd_FixedAtBuild_PcdMyHelloWorldPrintString[20] = {85, 69, 70, 73, 32, 72, 101, 108, 108, 111, 32, 87, 111, 114, 108, 100, 33, 10, 0 };
GLOBAL_REMOVE_IF_UNREFERENCED const UINTN _gPcd_FixedAtBuild_Size_PcdMyHelloWorldPrintString = 40;
GLOBAL_REMOVE_IF_UNREFERENCED const UINT32 _gPcd_FixedAtBuild_PcdMyHelloWorldPrintTimes = _PCD_VALUE_PcdMyHelloWorldPrintTimes;
...
{
  return MyHelloWorldPCDEntry (ImageHandle, SystemTable);
}
