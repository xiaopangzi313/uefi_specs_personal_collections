...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xBCB94005, 0x0049, 0x409E, {0xF7, 0x94, 0x67, 0x89, 0xDF, 0x85, 0x8B, 0x08}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CsdnRTIODebug";
...
{
  return CsdnRTIODebugEntryPoint (ImageHandle, SystemTable);
}
