...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x6AE7DE6E, 0xF0AF, 0x485f, {0x99, 0x37, 0xEB, 0x70, 0xFD, 0xCF, 0xC8, 0x2F}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MyHelloWorldDXEDriver";
...
{
  return MyHelloWorldDXEDriverEntry (ImageHandle, SystemTable);
}
