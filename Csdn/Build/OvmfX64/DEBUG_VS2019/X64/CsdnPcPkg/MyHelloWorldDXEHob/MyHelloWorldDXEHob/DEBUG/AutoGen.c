...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x69E6DE6D, 0xF09F, 0x485f, {0x99, 0x37, 0xEB, 0x70, 0xFD, 0xCF, 0xC8, 0x2F}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MyHelloWorldDXEHob";
...
{
  return MyHelloWorldDXEHobEntry (ImageHandle, SystemTable);
}
