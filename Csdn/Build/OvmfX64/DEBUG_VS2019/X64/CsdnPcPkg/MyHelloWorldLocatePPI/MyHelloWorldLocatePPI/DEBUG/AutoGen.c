...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x69E6DE6D, 0xF39F, 0x485f, {0x90, 0x37, 0xEB, 0x70, 0xFD, 0xCF, 0xC8, 0x2B}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MyHelloWorldLocatePPI";
...
{
  return MyHelloWorldLocatePPIEntry (FileHandle, PeiServices);
}
