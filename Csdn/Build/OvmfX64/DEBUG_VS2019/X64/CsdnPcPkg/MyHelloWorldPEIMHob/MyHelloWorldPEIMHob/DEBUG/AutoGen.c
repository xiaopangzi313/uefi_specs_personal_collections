...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x6BE6DE6D, 0xFB9E, 0x485f, {0x9A, 0x37, 0xEB, 0x70, 0xFD, 0xCF, 0xC8, 0x2B}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MyHelloWorldPEIMHob";
...
{
  return MyHelloWorldPEIMHobEntry (FileHandle, PeiServices);
}
