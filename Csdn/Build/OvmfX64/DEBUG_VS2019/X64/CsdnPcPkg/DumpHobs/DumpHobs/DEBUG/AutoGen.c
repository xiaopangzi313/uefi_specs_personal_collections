...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xb912f198, 0x0005, 0x2019, {0x02, 0x28, 0xb7, 0x57, 0xb8, 0x06, 0xec, 0x83}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "DumpHobs";
...
{
  return DumpHobEntry (ImageHandle, SystemTable);
}
