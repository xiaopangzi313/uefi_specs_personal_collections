...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xc913f198, 0x0004, 0x2020, {0x02, 0x37, 0xb7, 0x57, 0xb8, 0x06, 0xed, 0x85}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MyHelloworldInstallAcpiDxe";
...
{
  return MyHelloWorldInsatllAcpiEntry (ImageHandle, SystemTable);
}
