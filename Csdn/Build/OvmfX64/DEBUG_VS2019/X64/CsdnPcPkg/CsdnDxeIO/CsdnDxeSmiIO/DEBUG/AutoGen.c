...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0xBCB94008, 0x0045, 0x409E, {0x97, 0x94, 0x67, 0x89, 0xDF, 0x85, 0x8B, 0x08}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "CsdnDxeIO";
...
{
  return CsdnDxeSmiIOEntryPoint (ImageHandle, SystemTable);
}
