...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x79A6DE69, 0xF09C, 0x495f, {0x99, 0x37, 0xAB, 0x70, 0xFD, 0xCF, 0xC8, 0x2F}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MyHelloWorldDXEProtocol";
...
{
  return MyHelloWorldDXEProtocolEntry (ImageHandle, SystemTable);
}
