...
GLOBAL_REMOVE_IF_UNREFERENCED GUID gEfiCallerIdGuid = {0x69A69543, 0xFA9F, 0x485A, {0x9A, 0x3E, 0xEA, 0x70, 0xFD, 0xCF, 0xC8, 0x2F}};
...
GLOBAL_REMOVE_IF_UNREFERENCED CHAR8 *gEfiCallerBaseName = "MyMemMap";
...
{
  return MyMemMapEntry (ImageHandle, SystemTable);
}
