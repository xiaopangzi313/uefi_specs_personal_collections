...
#define FRONT_PAGE_KEY_CSDN                   0x1003
#define FRONT_PAGE_KEY_CSDN_RADIIO            0x1004
  ...
  )
{
  if (QuestionId != FRONT_PAGE_KEY_CONTINUE &&
      ...
      QuestionId != FRONT_PAGE_KEY_CSDN_RADIIO &&
...
/**
  Create Csdn menu in the front page.
  ...
  )
{
  HiiCreateActionOpCode (
    StartOpCodeHandle,
    FRONT_PAGE_KEY_CSDN,
    STRING_TOKEN (STR_CSDN_STRING),
    STRING_TOKEN (STR_CSDN_STRING_HELP),
    EFI_IFR_FLAG_CALLBACK,
    0
    );
}
...
/**
  Create CSDN menu in the front page with oneof opcode.
  ...
  )
{
  ...
  CsdnText = AllocatePool (22);
  ASSERT (CsdnText != NULL);
  ...
  if (!EFI_ERROR (Status)) {
    DEBUG((EFI_D_INFO,"[csdn] UiCreateCsdnRadioMenu = %a\n",CsdnText));
  }else{
    DEBUG((EFI_D_INFO,"[csdn] UiCreateCsdnRadioMenu = %r\n",Status));
  }
  ...
  HiiCreateOneOfOptionOpCode (
        OptionsOpCodeHandle,
        STRING_TOKEN (STR_CSDN_STRING_RADIO_1),
        EFI_IFR_OPTION_DEFAULT,
        EFI_IFR_NUMERIC_SIZE_1,
        0
        );
  ...
  HiiCreateOneOfOptionOpCode (
        OptionsOpCodeHandle,
        STRING_TOKEN (STR_CSDN_STRING_RADIO_2),
        EFI_IFR_OPTION_DEFAULT,
        EFI_IFR_NUMERIC_SIZE_1,
        1
        );
  ...
  HiiCreateOneOfOptionOpCode (
        OptionsOpCodeHandle,
        STRING_TOKEN (STR_CSDN_STRING_RADIO_3),
        EFI_IFR_OPTION_DEFAULT,
        EFI_IFR_NUMERIC_SIZE_1,
        2
        );
  ...
  HiiCreateOneOfOptionOpCode (
        OptionsOpCodeHandle,
        STRING_TOKEN (STR_CSDN_STRING_RADIO_4),
        EFI_IFR_OPTION_DEFAULT,
        EFI_IFR_NUMERIC_SIZE_1,
        3
        );
  ...
  HiiCreateOneOfOptionOpCode (
        OptionsOpCodeHandle,
        STRING_TOKEN (STR_CSDN_STRING_RADIO_5),
        EFI_IFR_OPTION_DEFAULT,
        EFI_IFR_NUMERIC_SIZE_1,
        4
        );
  ...
  HiiCreateOneOfOptionOpCode (
        OptionsOpCodeHandle,
        STRING_TOKEN (STR_CSDN_STRING_RADIO_6),
        EFI_IFR_OPTION_DEFAULT,
        EFI_IFR_NUMERIC_SIZE_1,
        5
        );
  ...
  HiiCreateOneOfOpCode (
    StartOpCodeHandle,
    FRONT_PAGE_KEY_CSDN_RADIIO,
    0,
    0,
    STRING_TOKEN (STR_CSDN_RADIO_STRING),
    STRING_TOKEN (STR_CSDN_RADIO_STRING_HELP),
    EFI_IFR_FLAG_CALLBACK,
    EFI_IFR_NUMERIC_SIZE_1,
    OptionsOpCodeHandle,
    NULL
