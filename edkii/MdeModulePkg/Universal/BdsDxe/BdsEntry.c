  ...
  )
{
  ...
  if (!PlatformRecovery) {
    ...
    do {
      ...
      //
      DEBUG ((EFI_D_ERROR," [CSDN]: Retry to boot if any of the boot succeed start ...\n"));
      ...
      EfiBootManagerFreeLoadOptions (LoadOptions, LoadOptionCount);
      DEBUG ((EFI_D_ERROR," [CSDN]: Retry to boot if any of the boot succeed end ...\n"));
    } while (BootSuccess);
  }
  //Not called
  DEBUG ((EFI_D_ERROR," [CSDN]: PlatformRecovery out of judgement ...\n"));
