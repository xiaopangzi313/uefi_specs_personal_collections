...
pause
""".format(root_work_space, root_work_space)
...
if sys.platform == 'win32':
    build_script = "build_fw.bat"
    lauch_script = "lauch_fw.bat"
    lauch_script_busybox = "lauch_fw_busybox.bat"
    build_script_str = build_cmd_win
    lauch_script_str = lauch_script_win
    lauch_script_busybox_str = lauch_script_win_busybox
else:
    build_script = "build_fw.sh"
    lauch_script = "lauch_fw.sh"
    lauch_script_busybox = "lauch_fw_busybox.sh"
